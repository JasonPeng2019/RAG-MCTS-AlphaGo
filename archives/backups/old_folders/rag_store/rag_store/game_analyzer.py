...
DEFAULT_KATAGO_PATH = REPO_ROOT / "katago_repo" / "KataGo" / "cpp" / "build-opencl" / "katago"
DEFAULT_KATAGO_CONFIG = REPO_ROOT / "katago_repo" / "run" / "analysis.cfg"
DEFAULT_KATAGO_MODEL = REPO_ROOT / "katago_repo" / "run" / "default_model.bin.gz"
DEFAULT_JSON_DIR = REPO_ROOT / "selfplay_output"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--katago-path', default=str(DEFAULT_KATAGO_PATH),
                       help='Path to KataGo executable')
    parser.add_argument('--config', default=str(DEFAULT_KATAGO_CONFIG),
                       help='Path to KataGo analysis config')
    parser.add_argument('--model', default=str(DEFAULT_KATAGO_MODEL),
