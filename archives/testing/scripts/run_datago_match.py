...
def _determine_game_result(katago: GTPController, logger: logging.Logger) -> str:
    """Ask KataGo to score the final position and map it to a match result."""
    ...
    logger.info("score calculation failed")
    return "Draw"
            ...
            while move_number < max_moves:
                ...
                if move == "RESIGN":
                    ...
                    if passes >= 2:
                        ...
                        results.append(_determine_game_result(katago, logger))
                        break
                else:
                    passes = 0
