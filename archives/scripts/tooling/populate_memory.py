...
Usage:
  PYTHONPATH=. python3 scripts/populate_memory.py --out data/memory/sample_mem
"""
...
from src.clients.katago_client import analysis_to_embedding, EmbeddingProjector
...
def main():
    ...
    p.add_argument("--sample", default="tests/sample_analysis.json")
    ...
    for i in range(args.n):
        ...
        if i == 0:
            try:
                from src.clients.katago_client import canonicalize_policy
