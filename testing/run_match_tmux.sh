#!/bin/bash
# Run DataGo vs KataGo recursive match in tmux

SESSION_NAME="datago_match_gpu4"
...
tmux send-keys -t $SESSION_NAME "python run_datago_recursive_match.py \\" C-m
...
tmux send-keys -t $SESSION_NAME "  --games 10 \\" C-m
